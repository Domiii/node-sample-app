...
var ComponentDefDef = {
    ...
    Host: HostCore.defHost(function(SharedTools, Shared, SharedContext) {
        ...
        var _clientInstallCode = CodeBuilder.serializeInlineFunction(function(clientData) {
            ...
            ComponentDef.installClientComponents(SharedComponents.Libs, libDefs);
                ...
                while (queue.length > iQueue) {
                    ...
                    for (var i = 0; i < currentNames.length; ++i) {
                        ...
                        if (!uniqueNames[componentName]) {
                            ...
                            // add definition and ctor arguments
                            installData.defs.push(def);
                            var hostComponent = Instance[componentName];
                            if (hostComponent && hostComponent.getClientCtorArguments) {
                                installData.ctorArguments[componentName] = hostComponent.getClientCtorArguments();
                            }
